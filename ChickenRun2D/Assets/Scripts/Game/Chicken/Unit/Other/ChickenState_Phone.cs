...
public class ChickenState_Phone : IState
{
    ...
    public ChickenState_Phone(IStateMachineProvider stateMachineProvider, ChickenUnitModel model)
    {
    ...
    private IEnumerator Timer()
    {
        ...
        _model.ActivateAnimation(ChickenAnimationType.Phone);
